...
import { ISSUE_PRIORITY_OPTIONS, ISSUE_STATUS_OPTIONS, ISSUE_TYPE_OPTIONS } from '#/views/erp/project/issue/data';
...
function submit() {
  ...
  emit('submit', { ...form, reporter_id: String(form.reporter_id).trim() });
}
</script>
  ...
  <ElDialog :model-value="modelValue" title="生成项目问题" width="680px" @close="close">
    <ElForm label-width="100px">
      ...
      <ElFormItem label="提出人" required>
        <StaffPicker v-model="form.reporter_id" placeholder="请选择提出人" />
      </ElFormItem>
