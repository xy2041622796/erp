...
const props = withDefaults(
  defineProps<{
    items?: ErpPurchaseReturnOutApi.PurchaseReturnOutItem[];
    disabled?: boolean;
...
const tableData = ref<ErpPurchaseReturnOutApi.PurchaseReturnOutItem[]>([]);
...
function validate() {
  if (!tableData.value.length) throw new Error('请先选择来源采购退货单并导入明细');
