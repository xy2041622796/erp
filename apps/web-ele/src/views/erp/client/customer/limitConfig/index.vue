...
import type { CrmCustomerLimitConfigApi } from '#/api/erp/customer/limitConfig';
...
import {
  ...
  LimitConfType,
} from '#/api/erp/customer/limitConfig';
          ...
          :actions="[
            {
              ...
              disabled: !hasAccessByCodes(['crm:customer-limit-config:create']),
          ...
          :actions="[
            {
              ...
              disabled: !hasAccessByCodes(['crm:customer-limit-config:update']),
            ...
            },
            {
              ...
              disabled: !hasAccessByCodes(['crm:customer-limit-config:delete']),
              popConfirm: {
