...
export const qualityFinalConfig: ProjectSubmoduleCrudConfig = {
  title: '最终检查',
  description: '按源项目 project_quality_final 语义迁入，支持最终检查编号、检查人、检查日期、结果摘要与状态维护。',
  primaryKey: 'id',
  defaultValues: {
    project_id: '',
    check_code: '',
  ...
  formSchema: [
    ...
    { fieldName: 'result_detail', label: '检查说明', component: 'Textarea', componentProps: { rows: 3 }, formItemClass: 'col-span-2' },
  ...
  columns: [
    ...
    { title: '结果摘要', field: 'result_summary', minWidth: 220 },
