...
export const progressReportConfig: ProjectSubmoduleCrudConfig = {
  ...
  formSchema: [
    ...
    },
    {
      ...
      component: 'Input',
      rules: 'required',
      componentProps: { readonly: true, class: '!w-full' },
    },
    {
      fieldName: 'reporter_id',
      label: '填报人',
  ...
  columns: [
    ...
    { title: '填报人', field: 'reporter_id', minWidth: 160 },
    { title: '填报人姓名', field: 'reporter_name', minWidth: 120 },
    { title: '日期', field: 'report_date', minWidth: 120 },
    { title: '进度', field: 'progress_percent', minWidth: 100, align: 'center' },
