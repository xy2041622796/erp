...
import OpeningCustomerTab from './opening-customer-tab.vue';
import OpeningProductStockTab from './opening-product-stock-tab.vue';
import OpeningSupplierTab from './opening-supplier-tab.vue';
