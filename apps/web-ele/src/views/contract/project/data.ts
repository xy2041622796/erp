...
export function useProjectGridColumns(): VxeTableGridOptions['columns'] {
  return [
    ...
    { title: '金额', field: 'project_amount', minWidth: 120, align: 'right' },
    { title: '状态', field: 'project_status', minWidth: 120, align: 'center' },
    {
      title: '操作',
      field: 'actions',
      fixed: 'right',
