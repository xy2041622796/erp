...
const api = createProjectSubmoduleCrudApi({
  navFormId: '7j3o9e2f1a4b5c6d7e8f9g0h1i2j3k4l',
  navigationUrl: 'quality/final',
  formKey: '7j3o9e2f1a4b5c6d7e8f9g0h1i2j3k4l',
  tableName: 'project_quality_final',
  dbName: 'LMBill',
  primaryKey: 'id',
  keywordFields: ["project_id","check_code","checker_name","result_summary","id"],
  defaultStatus: "待检查",
  statusField: 'status',
...
export async function generateIssue(row: Record<string, any>, issueInput: Record<string, any> = {}) {
  return await generateIssueFromQualityRecord(row, 'final', issueInput);
}
