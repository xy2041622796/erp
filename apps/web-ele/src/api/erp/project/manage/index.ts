...
import { calculateProjectHealth } from '#/api/erp/project/_business';
...
export namespace ErpProjectManageApi {
...
export function mapSourceStatusToTarget(status?: ErpProjectManageApi.SourceStatus | number | string) {
...
export function mapTargetStatusToSource(status?: number | string): ErpProjectManageApi.SourceStatus | undefined {
...
function normalizeProjectPayload(data: ErpProjectManageApi.Project & { source_status?: ErpProjectManageApi.SourceStatus | number | string }) {
...
export async function getProjectManagePage(params: PageParam & Record<string, any>) {
...
export async function getProjectManageSimpleList() {
  const projectTable = createProjectTable();
...
export async function getProjectManageOptionsPage(params: PageParam & Record<string, any> = {} as any) {
  const res = await getProjectManagePage({
    pageNo: Number(params.pageNo || 1),
    page: Number(params.page || 20),
    q: params.q,
  ...
  return {
    list,
    total: Number((res as any)?.total || list.length || 0),
  };
}
...
export async function getProjectManage(id: string) {
  const projectTable = createProjectTable();
...
export async function createProjectManage(data: ErpProjectManageApi.Project & { source_status?: ErpProjectManageApi.SourceStatus | number | string }) {
  const projectTable = createProjectTable();
...
export async function updateProjectManage(data: ErpProjectManageApi.Project & { source_status?: ErpProjectManageApi.SourceStatus | number | string }) {
...
export async function deleteProjectManage(id: string) {
...
export const NAVIGATION_URL = 'manage';
