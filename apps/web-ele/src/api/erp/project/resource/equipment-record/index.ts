...
const api = createProjectSubmoduleCrudApi({
  ...
  navigationUrl: 'resource/equipment-record',
  formKey: '1n7s3c6d5e8f9g0h1i2j3k4l5m6n7o8p',
  tableName: 'project_resource_equipment_record',
  dbName: 'LMBill',
  primaryKey: 'id',
  keywordFields: ['project_id', 'equipment_id', 'equipment_code', 'equipment_name', 'owner_user_name', 'owner_user_rowid', 'status', 'id'],
  defaultStatus: '领用中',
  statusField: 'status',
  datetimeFields: ['borrow_date', 'return_date'],
