...
export namespace ErpSettlementProjectApi {
...
export async function getSettlementProjectPage(params: any) {
...
export async function getSettlementProjectSimpleList() {
  const table = createFinanceDataTable(PROJECT_MODEL_ID, PROJECT_TABLE, PROJECT_DB, PROJECT_PK);
...
export async function getSettlementProject(id: string) {
  const table = createFinanceDataTable(PROJECT_MODEL_ID, PROJECT_TABLE, PROJECT_DB, PROJECT_PK);
